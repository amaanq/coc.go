...
//‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾
// Search Options for most endpoints
...
func (c *clanSearchOptions) SetWarFrequency(warFrequency WarFrequency) *clanSearchOptions {
...
func (c *clanSearchOptions) SetLocation(locationID LocationID) *clanSearchOptions {
	if !locationID.Valid() {
		return c
	}
...
func (c *clanSearchOptions) SetLabelIds(labelID ClanLabelID) *clanSearchOptions {
	if !labelID.Valid() {
		return c
	}
